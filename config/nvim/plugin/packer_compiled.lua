...
_G.packer_plugins = {
  ...
  ["colorbuddy.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/colorbuddy.nvim",
  ...
  ["neosolarized.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/neosolarized.nvim",
  ...
  ["nvim-bufferline.lua"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/nvim-bufferline.lua",
